				...
				String studyHTML = "";
					try{
						...
						for(i = 0;i < resources.size();i++){
							...
							if(task == 0){
								taskStr = "下载";
								downloadHTML += "<tr class='cname'><td>"+taskStr+"</td><td class='first'>【资源】"+rsname+"</td><td>"+rsuser+"</td><td>"+day+"</td><td><a href='download/"+rsurl+"'>下载</a></td><td>删除</td></tr>";
								downloadHTML += "<tr class='profile' ><td colspan='6' class='first'><p>【文件大小】："+rssize+"</p><p>【资源描述】"+rsprofile+"</p></td></tr>";
							} else {
								taskStr = "学习";
								studyHTML += "<tr class='cname'><td>"+taskStr+"</td><td class='first'>【资源】"+rsname+"</td><td>"+rsuser+"</td><td>"+day+"</td><td><a href='download/"+rsurl+"'>下载</a></td><td>删除</td></tr>";
