...
<html>
  ...
  <body>
		<div id="courseManage">
			...
			<div class="newCoure"><a href="admin/newItemClass.jsp"> 新建项目分类</a></div>
			<table border="1" cellspacing="0" cellpadding="0" id="course">
			<caption>项目分类信息</caption>
			<col width="90%"/>
			<col width="10%" />
			<tr class="head"><th>项目分类名称</th><th colspan="2">操作</th></tr>
			<%
				SpaceTeaModule spaceTM = new SpaceTeaModule();
				try{
					ArrayList<HashMap<String, Object>> course_classes = spaceTM.getAllItemClass();
					...
					for(int i = 0;i < course_classes.size();i++){
						...
						String url = "admin/viewItemClass.jsp?classid="+classid+"&class_name="+tClass_name;
