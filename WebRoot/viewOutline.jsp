...
<html>
  ...
  <body>
  	<div id="newsDeploy">
		<h2>实训要闻信息管理</h2>
		<p class="addLink"><a href="addNews.jsp?type=1">添加新闻文章</a></p>
		<table>
			...
			<%
				...
				ArrayList<HashMap<String,Object>> newsList = (ArrayList<HashMap<String,Object>>)news.get("outline");
				int infoid = 0;
				String info_title = "";
